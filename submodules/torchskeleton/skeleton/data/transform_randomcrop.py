...
class EfficientNetRandomCrop:
    def __init__(self, imgsize, scale=(0.08, 1.0), ratio=(3./4, 4./3), min_covered=0.1, max_attempts=10):
        ...
        self._fallback = EfficientNetCenterCrop(imgsize, 32)
...
class EfficientNetCenterCrop:
    ...
    def __call__(self, img):
        ...
        crop_size = float(self.imgsize) / (self.imgsize + self.pad) * image_short
