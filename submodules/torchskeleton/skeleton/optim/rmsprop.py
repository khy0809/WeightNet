# from: https://github.com/kakaobrain/fast-autoaugment/blob/2d7b27b3ddb05d073489d96977cd22175716ef09/FastAutoAugment/tf_port/rmsprop.py#L5
import torch
...
class TFRMSprop(Optimizer):
    ...
    def load_state_dict(self, state_dict):
        super(TFRMSprop, self).load_state_dict(state_dict)
