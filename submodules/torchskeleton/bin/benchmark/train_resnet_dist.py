...
def main():
    ...
    if args.schedule == 'multistep':
        scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, [(l + 5) * steps_per_epoch for l in [30, 60, 80]], gamma=0.1)
    ...
    for epoch in range(epochs):
        ...
        if world_rank == 0:
            ...
            summary_writers['train'].add_scalar('hyperparams/lr', scheduler.get_lr()[0], global_step=epoch)
